...
export const UserSchema = z.object({
  ...
  password: z.string().min(8, { message: "Le mot de passe doit faire au moins 8 caractères" }).regex(/\d/, { message: "Le mot de passe doit contenir un chiffre" }).regex(/[A-Z]/, { message: "Le mot de passe doit contenir une majuscule" }),
